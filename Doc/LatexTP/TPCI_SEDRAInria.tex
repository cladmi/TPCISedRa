...
\texttt{Python} is a dynamic language where many things are evaluated at run-time. So it is different from compiled languages. It means that if you do typos, errors may only occur when running the program. Using a static analysis program can detect errors without executing your program.

Another way to handle the typos and then to increase readability, is using coding standards for formatting your code. It make all your code look the same and it eases comprehension.
\\
