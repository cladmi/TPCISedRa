...
ln  -nfs python/abc_and_sphere  abc_and_sphere
\end{lstlisting}
\end{itemize}
...
For the C++ exercice, we use the following building and testing tools :
\begin{itemize}
\item \texttt{g++} compiler
\item \texttt{CMake} building tool
\item \texttt{cppunit} testing framework
\end{itemize}

So make sure you install all these tools an that you \texttt{PATH} environment is well setup accordingly.
