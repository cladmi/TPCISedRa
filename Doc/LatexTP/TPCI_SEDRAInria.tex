...
Sphere class offers an object constructor with the radius as parameter and a
volume method.
...
\item In Jenkins, add the scan for compiler warnings in the ``Post build Action'' of your project
...
This function provides coverage support through a new \texttt{make} target. You can see all \texttt{make} targets with the help target : \texttt{make help}
%$
