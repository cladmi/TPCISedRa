...
\begin{itemize}
\item \texttt{Git} (\texttt{apt-get install git} | \texttt{yum install git})
\item A JDK (\texttt{apt-get install openjdk-7-jdk} | \texttt{yum install java-1.7.0-openjdk})
\item \texttt{Maven} (\texttt{apt-get install maven} | \texttt{yum install apache-maven})
\end{itemize}
