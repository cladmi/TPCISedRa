...
\begin{itemize}
\item \texttt{yum install cmake cppunit gcc}
\end{itemize}
and on recent Debian or Ubuntu systems~:
\begin{itemize}
\item \texttt{apt-get install cmake cppunit gcc}
\end{itemize}
...
\begin{itemize}
\item Install coverage for the test TestVolume, you need to set the coveraged flags for the build of the library and the test with the \texttt{add\_cxx\_compiler\_flags} and to use the 
