...
SemVer intro? \url{http://semver.org/}
...
In this section you will write tests using \texttt{unittest} and execute them
...
coverage report. You will use this command in the upcoming steps.
