...
Have a look at the code of Sphere::computeVolume()
\begin{lstlisting}
...
Extract this value into a class data member and run the test again, it should fail:
...
\end{lstlisting}
You can then visualize the results in the reporting local website
\begin{lstlisting}
iceweasel target/site/cobertura/index.html &
\end{lstlisting}
Populate your tests to achieve 100\% test coverage.
